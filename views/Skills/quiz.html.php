...
?>
  <div class="container">
    ...
    <div class="row">
      <div id="quiz" data-quiz-id="<?= $this->esc($quizInfo['quiz_id']); ?>" data-crsf-token="<?= $this->esc($crsfToken); ?>" data-topic-slug="<?= $this->esc($curriculum['curriculum_slug'].'/'.$topic['slug'].'#skill-'.$skill['skill_id']); ?>" class="col-md-12">
      </div>
    </div><!-- row -->
