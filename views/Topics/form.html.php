      <div class="row justify-content-center">
        <div class="col-md-6 text-center">
          ...
          <div class="form-floating mb-3">
            <select class="form-select" aria-label="Select curricula" name="curriculum_id" id="curriculum_id">
              <?php foreach ($curricula as $curriculum) { ?>
                <option <?php if ($curriculum['curriculum_id'] == ($formVars['curriculum_id'] ?? '')) {
                    echo 'selected';
                } ?> value="<?= $this->esc($curriculum['curriculum_id']); ?>"><?= $this->esc($curriculum['curriculum_name']); ?></option>
              <?php } ?>
            </select>
          </div>
          <?php if (isset($errors['curriculum_id'])) { ?>
            <div class="alert alert-danger"><?= $this->esc($errors['curriculum_id']); ?></div>
          <?php } ?>
      ...
      <div class="row justify-content-center my-2">
        <div class="col-md-6">
          ...
          >
            <?= $this->esc($submitButtonText); ?> Topic
          </button>
        </div>
      </div>
    </form>
