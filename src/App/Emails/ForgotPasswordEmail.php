...
class ForgotPasswordEmail extends EmailMessage
{
    protected function prepareEmail(array $mailInfo)
    {
        ...
        $subject = 'Password Reset Request | MathsVoyage.com';

        // Now, put together the body of the email
        $bodyText = 'Hi '.htmlspecialchars($mailInfo['givenName'], ENT_QUOTES, 'UTF-8').",\n".
                "\nTo reset your MathsVoyage.com password click on the following link:".
                "\n\n$resetLink".
                "\n\nThis link will remain valid for 24 hours and can be used once only.".
                "\n\nKind regards,\nJeff Plumb.";

        $bodyTextHtml = 'Hi '.htmlspecialchars($mailInfo['givenName'], ENT_QUOTES, 'UTF-8').',<br /><br />To reset your MathsVoyage.com password click on the following button:';

        $bodyHtml = $this->emailTemplate->addEmailHeader('Password Reset Request | MathsVoyage.com');
